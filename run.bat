...
javac -cp "bin;lib/mysql-connector-j-9.6.0.jar" -d bin src\com\parksmart\SmsService.java src\com\parksmart\ParkSmartApp.java src\com\parksmart\ParkSmartUserPage.java src\com\parksmart\ParkSmartAdminLauncher.java
